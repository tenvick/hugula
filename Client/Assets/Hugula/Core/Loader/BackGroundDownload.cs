...
namespace Hugula.Loader {
    ...
    public class BackGroundDownload : MonoBehaviour {
        ...
        /// <summary>
        /// Releases all resource used by the <see cref="Hugula.Loader.BackGroundDownload"/> object.
        /// </summary>
        /// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="Hugula.Loader.BackGroundDownload"/>. The
        /// <see cref="Dispose"/> method leaves the <see cref="Hugula.Loader.BackGroundDownload"/> in an unusable state. After calling
        /// <see cref="Dispose"/>, you must release all references to the <see cref="Hugula.Loader.Dispose"/> so the garbage
        /// collector can reclaim the memory that the <see cref="Hugula.Loader.BackGroundDownload"/> was occupying.</remarks>
