...
static void singlevar (LexState *ls, expdesc *var) {
  ...
  if (var->k == VVOID) {  /* global name? */
    ...
    luaK_exp2anyregup(fs, var);  /* but could be a constant */ /*https://github.com/lua/lua/commit/1f3c6f4534c6411313361697d98d1145a1f030fa Bug: Lua can generate wrong code when _ENV is <const> */
