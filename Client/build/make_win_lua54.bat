...
cmake -DLUA_VERSION=5.4.6 -DLUAC_COMPATIBLE_FORMAT=ON -G "Visual Studio 17 2022" -A x64  ..
popd
...
cmake -DLUA_VERSION=5.4.6 -DLUAC_COMPATIBLE_FORMAT=ON -G "Visual Studio 17 2022" -A Win32 ..
popd
